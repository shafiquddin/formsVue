<template>
  <form @submit.prevent="submitForm">
    <div class="form-control" :class="{invalid:userNameValidaty=='invalid'}">
      ...
      <input id="user-name" name="user-name" type="text" v-model.trim="userName" @blur="validateUser"/>
      <p v-if="userNameValidaty=='invalid'">Please Enter User Name</p>
    </div>
    ...
    <div class="form-control">
      <input type="checkbox" name="confirm" id="confirm" v-model="confirm">
      <label for="confirm">Are you sure for confirm?</label>
    </div>
    <div>
